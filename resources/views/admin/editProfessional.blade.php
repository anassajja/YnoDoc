...
<body>
    <div class="container">
        ...
        <form method="POST" action="{{ route('admin.updateProfessional', ['id' => $professional->id]) }}">
            @csrf
            @method('PUT')

            <div class="form-group">
                <label for="titre">Title:</label>
                <input type="text" id="titre" name="titre" value="{{ $professional->titre }}" class="form-control" required>
            </div>

            <div class="form-group">
                <label for="name">Name:</label>
                <input type="text" id="name" name="name" value="{{ $professional->name }}" class="form-control" required>
            </div>

            <div class="form-group">
                <label for="persoPhone">Personal Phone:</label>
                <input type="text" id="persoPhone" name="persoPhone" value="{{ $professional->persoPhone }}" class="form-control" required>
            </div>

            <div class="form-group">
                <label for="email">Email:</label>
                <input type="email" id="email" name="email" value="{{ $professional->email }}" class="form-control" required>
            </div>
